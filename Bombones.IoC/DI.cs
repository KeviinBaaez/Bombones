...
namespace Bombones.IoC
{
    public static class DI
    {
        public static IServiceProvider ConfigurarServicios()
        {
            ...
            service.AddScoped<IRepositorioFormasVentas, RepositorioFormasVentas>();
            service.AddScoped<IServiciosFormaVenta, ServiciosFormaVenta>();
            ...
            service.AddScoped<IServiciosFormaVenta>(sp =>
            {
                var repositorio = new RepositorioFormasVentas();
                return new ServiciosFormaVenta(repositorio, cadena);
            });
